...
const GallerySection = ({
  ...
  // Fix refresh blank grid by not depending on whileInView
  const shouldShowGrid =
    !galleryLoading;

  const gridAnimateState =
    shouldShowGrid
      ? "show"
      : "hidden";
  ...
  // ADMIN ADD GALLERY
  // NOTE:
  // Existing Firebase structure intentionally retained
  // for the prototype.
  // =====================================================
  ...
  const handleUpload =
    async () => {
      if (!isAdmin) {
        return toast.error(
          "Only admins can add to gallery."
        );
      }
      ...
      try {
        ...
        // Existing Springfield Firebase storage structure
        // intentionally retained for prototype
        const path =
          `springfieldschool/${SCHOOL_ID}/gallery/${safeName}`;
        ...
        // Existing Firestore structure intentionally retained
        await addDoc(
          collection(
            db,
            "springfieldschool",
  ...
  const handleDeleteConfirm =
    async () => {
      if (!isAdmin) {
        return toast.error(
          "Only admins can delete gallery."
        );
      }
        ...
        >
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-blue-900 leading-tight">
              {title ||
                "Moments from Bernard International Montessori School"}
            </h2>
        ...
        {!galleryLoading &&
          ...
          filtered.length ===
            ...
            <div className="mt-10 text-center text-slate-600">
              ...
              {isAdmin
                ? "Click “Add to Gallery” to upload."
                : ""}
            </div>
          )}
      </div>
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Classroom Learning Session"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="e.g. Pupils enjoying a creative learning activity..."
                      rows={4}
