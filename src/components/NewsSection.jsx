...
const NewsSection = ({
  title = "Latest from Bernard International Montessori School",
  ...
  // ADD NEWS
  //
  // Existing Springfield Firestore structure is retained
  // intentionally for the prototype.
  // =====================================================
